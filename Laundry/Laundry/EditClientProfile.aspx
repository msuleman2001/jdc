<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashBoard.Master" AutoEventWireup="true" CodeBehind="EditClientProfile.aspx.cs" Inherits="Laundry.EditClientProfile" %>
    ...
    <div class="container">
        <table class="table-responsive" style="border-collapse:separate; border-spacing:0 5px;">
            ...
            <tr>
                <td>Password</td>
                <td></td>
                <td ><asp:TextBox ID="txtPassword" Width="100%" class="form-control"  required="true" placeholder="Password" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td>Image</td>
                <td></td>
            ...
            <tr>
                <td>IsEnabled</td>
                <td></td>
                <td ><asp:CheckBox class="form-control"  BackColor="#cc00ff" ID="chkenable"  runat="server"></asp:CheckBox></td>
