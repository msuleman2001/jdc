...
namespace DataKernal
{
	public class CustomerProfile
	{
		...
		public DataSet InsertUpdateCustomerProfile(Int64 intClientID, string strCustomerName, string strCustomerAddress, string strCustomerPhoneNo, string strCustomerEmail, string strCustomerPassword, DateTime datDateJoind, string strCustomerRemarks, bool blnIsEnabled)
		{
			try
			{
				//parameter setting
